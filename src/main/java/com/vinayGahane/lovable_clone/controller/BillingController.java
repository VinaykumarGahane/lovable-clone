...
import com.vinayGahane.lovable_clone.dto.subscription.*;
...
public class BillingController {
    ...
    public ResponseEntity<CheckoutResponse> createCheckutResponse(@RequestBody CheckoutRequest checkoutRequest){
        Long userId=1L;
